...
public class DateAndTime_02_Test {
	...
	public void test_localDate_of() {
		...
		// TODO créer un objet LocalDate à la date 24/12/2050 // OK
	...
	public void test_localDate_parse() {
		...
		// TODO créer un objet LocalDate à la date 10/01/1990 // OK
	...
	public void test_localDate_format() {
		...
		// TODO créer un objet LocalDate à la date 11/03/2015 // OK
		LocalDate localDate = LocalDate.of(2015, 03, 11);
		
		

		// TODO Formatter la date pour que le test soit passant // OK
